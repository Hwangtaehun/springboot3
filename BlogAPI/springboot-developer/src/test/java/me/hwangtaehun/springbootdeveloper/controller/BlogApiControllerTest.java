...
import me.hwangtaehun.springbootdeveloper.dto.UpdateArticleRequest;
...
class BlogApiControllerTest {
    ...
    @DisplayName("findAllArticles: 블로그 글 삭제에 성공한다.")
    @Test
    ...
    @DisplayName("findAllArticles: 블로그 글 수정에 성공한다.")
    @Test
